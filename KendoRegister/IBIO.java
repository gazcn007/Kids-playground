...
public class IBIO {
	// all projects have a main method somewhere that is always run
	public static void main(String[] args) {
		new IBIO();
	}

	// Constructor method to actually make objects of the class einstein

	public IBIO () {
	//instructions of main class go here.
